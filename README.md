...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/222)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/222
```

A live public deployment of this template is available at [https://222.templates.workers.dev](https://222.templates.workers.dev)
